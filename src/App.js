...
import { FiUpload, FiMessageSquare, FiCheckCircle, FiArrowRight, FiLoader, FiSend, FiUser, FiCpu, FiChevronDown, FiFileText } from 'react-icons/fi';
import './App.css';
    ...
    <div className="app bg-gray-50 min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-8 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto">
          <HeroSection onScroll={() => setActiveSection('upload-section')} />
          <HowItWorksSection />
          <UploadSection 
            file={file} 
            project={project} 
...
const ChatModule = ({ messages, inputMessage, setInputMessage, onSend, chatContainerRef }) => {
